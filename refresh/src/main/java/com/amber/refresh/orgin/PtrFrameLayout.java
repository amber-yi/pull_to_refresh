...
import com.amber.refresh.utlis.PtrCLog;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (arr != null) {
            mHeaderId = arr.getResourceId(R.styleable.PtrFrameLayout_ptr_header_id, mHeaderId);
            mContainerId = arr.getResourceId(R.styleable.PtrFrameLayout_ptr_content_id, mContainerId);
            mFooterId = arr.getResourceId(R.styleable.PtrFrameLayout_ptr_footer_id, mFooterId);
            ...
            mMode = getModeFromIndex(arr.getInt(R.styleable.PtrFrameLayout_ptr_refresh_mode, 4));
            arr.recycle();
        }
